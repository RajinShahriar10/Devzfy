...
const techLogos: { name: string; gradient: string; icon: React.ReactNode }[] = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
        <path d="M10.308 7.077h3.385l1.077 1.539-.615 2.308-1.539.615-.77-.615-.307 1.539.615.461.846.077.615.846.077 1.077-1.077.307L12 14.461l-.846.154-1.154-.615-.539-1.231.154-1.539.385-.77.539.231.231.307-1.077.846-1.154-.154L6.615 12l.231-.846.615-.308.308.77.77.384.308-.77-.308-.923-.538.384-.846.616.308-1.077.846-.384.539.615 1.462-.153.846-.154 1.077.231.539.077.077-.923.307-.461-.23-.231.693-.385 1.231.461-.077.539-.154 1.308-.461.846-.539 1.231-.384 1.077-.154-3.231-1.077-.231-3.693zm-4.462 0h3.385l-.077 1.616-.769.307-1.231.77.077 1.154.923.538.539.077.846-.077.538-.846.231.461-.154.616-.693.539-.77.538-.923.308-1.077-.308-.77-.615-.308-.77.154-1.231.384-.77.154-.615-.539-.615-1.231-.462-.23-1.539V8.308c0-.615.307-.923.923-1.231z" />
      </svg>
    ),
  },
];
